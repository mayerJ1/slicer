...
#include "MeshGroup.h"
#include "Ratio.h" //For the shrinkage percentage and scale factor.
#include "floatpoint.h" //To accept incoming meshes with floating point vertices.
#include "FMatrix4x3.h" //To transform the input meshes for shrinkage compensation and to align in command line mode.
#include "gettime.h"
#include "str.h"
